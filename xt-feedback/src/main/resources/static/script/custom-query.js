...
$(document).ready(function() {
    ...
    $("#submit").click(function() {
        ...
        $.ajax({
            url : baseUrl+"teacher/query/teaching/list",
            type: "post",
            ...
            success : function(result) {
                ...
                for(var i = 0; i < listTeaching.length; i++) {
                    ...
                    $("#course-list").append("<a href='teacher/custom/create/"+listTeaching[i].teachingId+"' class='list-group-item'><span class='icon-eyeglass icons float-right'></span>"+course.course+"("+course.courseNoAndOrder+")</a>");
                }
            }
        });
    });
